...
// Define constants
#define MEDIUM_DISTURBANCE_PROB_GOATFISH 0.01
#define MEDIUM_DISTURBANCE_PROB_FISH 0.08
#define MEDIUM_DISTURBANCE_PROB_SENESCENCE 0.01
#define HOTSPOT_RADIUS 80          // Radius of hotspots
#define COLDSPOT_RADIUS 80         // Radius of coldspots
#define HOTSPOT_INTENSITY 0.01      // Added disturbance probability in hotspots
#define COLDSPOT_INTENSITY 0.01     // Reduced disturbance probability in coldspots
